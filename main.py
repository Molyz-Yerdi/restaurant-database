...
def BtnEnter():                                                                 # Функция ввода данных в базу
    if combo_tables.get() == 'Clients':
        ...
        if name == '':
            print('Некорректное пустое значение')
        else:
    ...
    if combo_tables.get() == 'Compositions':
        if '' in [entry_id_order_comp.get(), entry_id_pizza_comp.get()]:
            print('Некорректное пустое значение')
        else:
    ...
    if combo_tables.get() == 'Menu':
        lisst = [entry_pizza_name_menu.get(),
    ...
    if combo_tables.get() == 'Orders':
        lisst = [entry_date_order_ord.get(),
    ...
    if combo_tables.get() == 'Schedule':
        lisst = [entry_id_stuffer_sch.get(),
    ...
    if combo_tables.get() == 'Warehouse':
        lisst = [entry_name_ingred_wh.get(),
                 entry_price_wh.get(),
